  ...
  partial class RemoveCompletePage
    {
      ...
      this.RemovedServerInstallationsListView = new MySql.Configurator.UI.Controls.MyListView();
    ...
    " reboot your computer when done?";
      ...
      this.RemoveCompleteFlowLayoutPanel.Controls.Add(this.RemovedServerInstallationsListView);
      ...
      // 
      // RemovedServerInstallationsListView
      // 
      this.RemovedServerInstallationsListView.AccessibleDescription = "A list view containing selected products that have been removed";
      this.RemovedServerInstallationsListView.AccessibleName = "Removed Server Installations List";
      this.RemovedServerInstallationsListView.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
            this.ProductIconColumnHeader,
            this.ProductNameColumnHeader,
            this.ProductVersionColumnHeader});
      this.RemovedServerInstallationsListView.HideSelection = false;
      this.RemovedServerInstallationsListView.Location = new System.Drawing.Point(3, 3);
      this.RemovedServerInstallationsListView.Name = "RemovedServerInstallationsListView";
      this.RemovedServerInstallationsListView.OwnerDraw = true;
      this.RemovedServerInstallationsListView.ProgressBarCol = 0;
      this.RemovedServerInstallationsListView.ProgressBarRow = 0;
      this.RemovedServerInstallationsListView.ShowItemToolTips = true;
      this.RemovedServerInstallationsListView.Size = new System.Drawing.Size(505, 201);
      this.RemovedServerInstallationsListView.TabIndex = 0;
      this.RemovedServerInstallationsListView.UseCompatibleStateImageBehavior = false;
      this.RemovedServerInstallationsListView.View = System.Windows.Forms.View.Details;
      // 
      ...
      this.PerformLayout();
        ...
        #endregion
        private MyListView RemovedServerInstallationsListView;
