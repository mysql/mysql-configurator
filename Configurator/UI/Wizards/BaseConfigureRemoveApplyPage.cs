...
namespace MySql.Configurator.UI.Wizards
{
  public partial class BaseConfigureRemoveApplyPage : WizardPage
  {
    ...
    protected ServerConfigurationController CurrentController;
    ...
    public BaseConfigureRemoveApplyPage(ServerConfigurationController controller)
      : this()
    {
    ...
    protected DialogResult CancelConfigurationAfterTimeout()
    {
      var dialogProperties = InfoDialogProperties.GetInformationDialogProperties(
          string.Format(Resources.ConfigureHasTimedOutTitle, CurrentController.ServerInstallation.NameWithVersion),
