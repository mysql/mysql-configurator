...
namespace MySql.Configurator.UI.Wizards.ServerConfigPages
{
  ...
  public partial class ServerConfigNamedPipesPage : ConfigWizardPage
  {
    ...
    {
      Base.Classes.Utilities.OpenBrowser($"https://dev.mysql.com/doc/refman/{AppConfiguration.Version.Major}.{AppConfiguration.Version.Minor}/en/server-system-variables.html#sysvar_named_pipe_full_access_group");
    }
  }
}
