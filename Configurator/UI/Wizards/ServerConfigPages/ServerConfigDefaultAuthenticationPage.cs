...
namespace MySql.Configurator.UI.Wizards.ServerConfigPages
{
  ...
  public partial class ServerConfigDefaultAuthenticationPage : ConfigWizardPage
  {
    ...
    public override bool Next()
    {
      ...
      if (!_controller.ServerInstallation.Version.ServerSupportsDefaultAuthenticationPluginVariable()
      ...
      if (_controller.ConfigurationType == Base.Enums.ConfigurationType.Upgrade)
      {
