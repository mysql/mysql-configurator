  ...
  public partial class ServerConfigUserAccountsPage : ConfigWizardPage
  {
    ...
    public override bool Next()
    {
      ...
      if (UserAccountPanel.Visible)
      {
        ...
        foreach (var su in from ListViewItem li in UserAccountsListView.Items select li.Tag as MySqlServerUser)
        {
    ...
    private string CheckPasswords()
    {
      return !_dataDirectoryConfigured
        ? Base.Classes.Utilities.ValidatePasswords(RootPasswordTextBox.Text, RepeatPasswordTextBox.Text, PasswordStrengthLabel)
        : null;
    }
    ...
    private void SetControlsVisibility()
    {
      ...
      _showWinAuthOption = _controller.ServerInstallation.Version.ServerSupportsWindowsAuthentication()
                          && _controller.ServerInstallation.License == LicenseType.Commercial;
