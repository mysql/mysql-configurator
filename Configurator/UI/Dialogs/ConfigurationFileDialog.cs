...
namespace MySql.Configurator.UI.Dialogs
{
  ...
  public partial class ConfigurationFileDialog : AutoStyleableBaseDialog
  {
    ...
    protected void CheckDirectory()
    {
      ...
      var iniFilePath = Path.Combine(path, MySqlServerSettings.DEFAULT_CONFIG_FILE_NAME);
      var alternateIniFilePath = Path.Combine(path, MySqlServerSettings.ALTERNATE_CONFIG_FILE_NAME);
