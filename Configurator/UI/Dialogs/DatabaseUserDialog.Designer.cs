...
namespace MySql.Configurator.UI.Dialogs
{
  partial class DatabaseUserDialog
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.PasswordStrengthLabel = new MySql.Configurator.UI.Controls.PasswordStrengthLabel();
      ...
      this.UserRoleComboBox = new MySql.Configurator.UI.Controls.ImageComboBox();
