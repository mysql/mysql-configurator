...
namespace MySql.Configurator.UI.Dialogs
{
  public partial class DatabaseUserDialog : Form
  {
    ...
    /// </summary>
    public MySqlServerUser ServerUser
    {
      get => _serverUser;
    ...
    {
      Base.Classes.Utilities.NormalizeFont(this);
      base.OnLoad(e);
    }
        ...
        case nameof(ConfirmPasswordTextBox):
          if (mysqlAuthentication)
          {
            ...
            errorMessage = textBox.Text == string.Empty
              ? string.Empty
              : Base.Classes.Utilities.ValidatePasswords(PasswordTextBox.Text, ConfirmPasswordTextBox.Text, PasswordStrengthLabel);
    ...
    {
      Base.Classes.Utilities.OpenBrowser("https://dev.mysql.com/doc/refman/en/windows-pluggable-authentication.html#windows-pluggable-authentication-usage");
    }
