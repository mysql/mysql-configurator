...
namespace MySql.Configurator.UI.Controls
{
  ...
  public partial class RemoveStepControl : ConfigStepControl
  {
    ...
    public RemoveStepControl(List<RemoveStep> subSteps, ServerConfigurationController controller) : base()
    {
      InitializeComponent();
    ...
    /// <summary>
    /// The <see cref="ServerConfigurationController"/> associated with this control.
    /// </summary>
