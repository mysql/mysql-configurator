...
{
  /// <summary>
  /// The mode in which MySQL Configurator is running.
  /// </summary>
  public enum ExecutionMode : uint
  {
    ...
    Configure = 0,
    /// <summary>
    /// Execution mode in which a server configuration is being removed.
    /// </summary>
    Remove = 1,
    /// <summary>
    /// Execution mode in which a server configuration is attempted to be removed. If there is nothing to remove
