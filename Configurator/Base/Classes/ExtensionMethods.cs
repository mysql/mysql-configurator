...
using MySql.Configurator.Base.Attributes;
...
namespace MySql.Configurator.Base.Classes
{
  public static class ExtensionMethods
  {
    ...
    public static string FindValue(this IniFile iniFile, string section, string key, bool includeCommentedKeys)
    {
    ...
    public static Tuple<ConfigurationKeyType, string> FindValueWithState(this IniFile iniFile, string section, string key)
    {
      if (iniFile.IsNull())
        return new Tuple<ConfigurationKeyType, string>(ConfigurationKeyType.NotPresent, string.Empty);
    ...
    public static T FindValue<T>(this IniFile iniFile, string section, string key, bool includeCommentedKeys)
    {
      T t = default(T);
    ...
    public static string GetHostIdentifier(this MySqlConnectionStringBuilder stringBuilder)
    {
      ...
      switch (stringBuilder.ConnectionProtocol)
      {
        ...
        case MySqlConnectionProtocol.NamedPipe:
          return $"Mysql@local:{stringBuilder.PipeName}";

        default:
          return $"Mysql@{stringBuilder.Server}:{stringBuilder.Port}";
      }
    }
