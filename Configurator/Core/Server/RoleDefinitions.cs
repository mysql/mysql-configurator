...
namespace MySql.Configurator.Core.Server
{
  ...
  public sealed class RoleDefinitions
  {
    ...
    /// <param name="serverUser">The <see cref="MySqlServerUser"/> to create or update.</param>
    ...
    {
      serverUser.Username = serverUser.Username.SanitizeQuotedString();
      ...
      if (serverUser.AuthenticationPlugin == MySqlAuthenticationPluginType.Windows)
      {
        ...
        builder.Append(Utilities.StandardizeToMySqlUserDomainSyntax(serverUser.WindowsSecurityTokenList));
        builder.Append("'");
      }
      else
      {
    ...
    /// <summary>
    /// Returns a list of SQL statements to execute to modify privileges for the given <see cref="MySqlServerUser"/>.
    /// </summary>
    /// <param name="serverUser">A <see cref="MySqlServerUser"/>.</param>
    /// <returns>A list of SQL statements to execute to modify privileges for the given <see cref="MySqlServerUser"/>.</returns>
    public List<string> GetUpdateUserSql(MySqlServerUser serverUser)
    {
