...
namespace MySql.Configurator.Core.Classes.MySqlWorkbench
{
  ...
  public class MySqlWorkbenchConnectionExtraParameters : INotifyPropertyChanged
  {
    ...
    protected XmlElement GetParameterValuesElementWithBaseConnectionParent(XmlDocument doc)
    {
      ...
      var connectionElement = doc.CreateElement("value");
      ...
      var parameterValues = doc.CreateElement("value");
      ...
      XmlRepository.AppendPropertyValueToElement(doc, connectionElement, "name", "string", Name);
